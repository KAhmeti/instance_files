...
INTERFACE="st0.155"
CLIENT_NAME="TJX-CORP"
REMOTE_END="168.233.20.22"
LOCAL_END="35.196.173.45"
PRESHARED_KEY="33c7526cc4c8f53fb7439a65bcf5f20845b78fff903971295a12cd57"
LAN="10.169.254.195/32"
NAT="100.123.0.1/32"
RULE_1="45"
RULE_2="TJX-CORP"
...
#set security nat static rule-set me-to-all-clients rule 45 then static-nat prefix 10.169.254.195/32 routing-instance TJX-CORP
