...
ROUTER_IP="35.237.180.85"
SSH_USER="kastriot"
SSH_PRIVATE_KEY="/home/kastriot/.ssh/id_rsa"
INTERFACE="st0.26"
CLIENT_NAME="hb-reavis"
REMOTE_END="79.173.135.2"
LOCAL_END="34.148.113.148"
PRESHARED_KEY="44438ba7f4b7a253bfff3f484e41acb80b6cc978cc938cc698d768c4"
LAN="10.10.120.0/24"
NAT="100.120.39.0/24"
RULE_1="26"
RULE_2="hb-reavis"
...
#set security nat static rule-set me-to-all-clients rule $RULE_1 match destination-address $NAT
#set security nat static rule-set me-to-all-clients rule $RULE_1 then static-nat prefix $LAN routing-instance $CLIENT_NAME
#set security nat source pool KODE address 100.64.0.6/32
